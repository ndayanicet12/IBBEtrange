# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2017-07-18 09:23
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('beneficiary', models.CharField(max_length=100, verbose_name='Beneficaire ')),
                ('address', models.CharField(max_length=50, verbose_name='Adresse du beneficiaire')),
                ('bank', models.CharField(max_length=20, verbose_name='Banque')),
                ('accountbank', models.CharField(max_length=20, verbose_name='Numero de Compte ')),
                ('amountletter', models.CharField(max_length=256, verbose_name='Montant en lettres')),
                ('detailpayment', models.TextField(max_length=20, verbose_name='Detals de paiement')),
                ('datepayment', models.DateTimeField(auto_now_add=True, verbose_name='Date')),
                ('principal', models.CharField(max_length=50, verbose_name="Donneur d'ordre")),
